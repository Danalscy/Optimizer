...
public class Connection {
    ...
    public int hashCode() {
        ...
        hash = 43 * hash + Objects.hashCode(this.timeRequired);
        hash = 43 * hash + Objects.hashCode(this.timeOpen);
        hash = 43 * hash + Objects.hashCode(this.timeClose);
        hash = 43 * hash + (this.open ? 1 : 0);
